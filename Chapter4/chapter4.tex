...
fall due to gravity, forming a randomly packed granular column (see Chapter 4). 
...
on the energy dissipation mechanism is discussed in section %TODO: ADD SECTION. 
...
in the run-out distance beyond the aspect ratio of 2.3.~\citet{Bandara2009} 
also observed a jump in the run-out distance at the transition region, i.e. 
initial aspect ratio of 2.
...
at an aspect ratio of 0.7.~\citet{Schaefer1990} observed the onset of 
