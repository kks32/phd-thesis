...
Generalised Interpolation Material Point Method (GIMPM). GIMPM  with  
Mohr-Coloumb failure criterion is used to describe the continuum behaviour of 
granular column collapse. While the micro-mechanics of the flow is captured 
using DEM simulations. Comparing the grain scale behaviour with the continuum 
...
Coefficient of restitution, $\Gamma$ & 0.755 \\ \bottomrule
\end{tabular}
\end{table}
...
Table.~\cref{table:MPMData}. The Young's modulus of the granular assembly is 
