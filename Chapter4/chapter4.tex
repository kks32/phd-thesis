...
column collapse are performed by varying the initial aspect ratio of the column 
from 0.2 to 10. The evolution of run-out and the flow kinematics observed in 
both approaches are compared to understand the ability and limitations of these
...
distances.~\Cref{fig:height} shows the normalized final height as a function of 
