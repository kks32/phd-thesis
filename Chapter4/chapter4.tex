...
simulations of collapse of loose (79\% packing density) and a dense (83\% 
...
of the granular pile in equilibrium, before the horizontal excitation, in the 
MPM simulation is shown in~\cref{fig:MPM_Stress_Slope}. The distribution of the 
initial gradient horizontal excitation energy of 50~\si{J} on the granular pile 
is shown in~\cref{fig:MPM_Velocity_Slope}. The Mohr-Coulomb model 
...
gradient horizontal excitation is studied. The initial 
...
distribution of initial horizontal excitation of 50J in the granular 
mass. A detailed description of this problem and the material properties used 
in the 
...
slope subjected to an initial horizontal energy $E_0 = 61$ (in dimensionless 
units) 
...
flows, column collapse and slope subjected to horizontal exciation, show 
