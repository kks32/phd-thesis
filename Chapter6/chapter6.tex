...
the behaviour of granular flows down inclined planes (\Cref{fig:setup}). 
...
by the density of the flowing mass. Loose column is more likely to hydroplane 
than the dense granular mass. The loose column entrains more water 
