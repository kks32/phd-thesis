...
evolution of local packing density with time shows that the packing 
...
high Froude's number.~\Cref{fig:KExy_a08_loose} shows that the peak horizontal 
kinetic velocity observed in the case of r = 0.9 R is higher than r = 0.95 R.  
A Froude's number of 0.59 for r = 0.9 R is observed in contrast to 0.46 for r = 
...
3\tau_c$.~\Cref{fig:Packing_Density_a08_loose} shows the evolution of packing 
fraction with time for different values of permeability. As the flow 
...
observed in the loose condition, this is shown by white-coloured cells at the 
flow front. Comparing the packing density 
