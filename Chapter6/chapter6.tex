...
simimated for randomly packed beds of spherical grains. The variation of 
...
hydrodynamic radius decreases the permeability of the granular assembly 
resulting in longer duration for the dissipation of negative pore pressure. 

The normalised run-out for different hydrodynamic radius for a granular column 
...
The influence of slope angle on the effect of permeability and initial packing 
...
the behaviour of granular flows on inclined planes (see~\Cref{fig:setup}). The 
...
compared to it's dry counterpart (see~\Cref{fig:KE_dense}). With increase in 
...
(see~\Cref{fig:slope_loose}). For the same thickness of flow, loose granular 
...
the dense condition (see~\Cref{fig:KE_loose}).
...
front due to entrainment of water.~\Cref{fig:slope_runout} shows that for a 
