...
where $\mu$ is the dynamic viscosity of the fluid (Pa.s), $\Delta x$ is the 
thickness 
of the bed of porous medium (m), and $\Delta P$ is the applied pressure 
difference (Pa).  In the present study, the radius is varied from 0.7 to 0.95 
to obtain a 
