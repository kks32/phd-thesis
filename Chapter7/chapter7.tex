...
efficiency. 
%The algorithm of the MPM code is improved to handle multi-body dynamics and 
%interactions.
...
\subsubsection*{Granular slopes subjected to horizontal excitation}
...
horizontal velocities reveals a power-law dependence of the run-out distance 
