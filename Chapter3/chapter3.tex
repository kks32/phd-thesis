...
represent a discrete region of the body. MPM facilitates representation of 
arbitrarily complex geometries and has advantages over strictly grid based 
methods especially in simulations involving contact between multiple 
objects~\citep{Bardenhagen2000}. MPM poses a whole new set of visualization 
problem, it is essential to visualize the general configuration of the body as 
well as to observe the finer details like development of cracks or separation 
of chunk of material from the body. The body is discretised into conceptual 
material points, which carry all the relevant information of the corresponding 
segment. The unique qualities of MPM necessitate the need to visualize the 
particle data in a way that is informative and appropriate.
...
There are two vital aspects in visualizing MPM data: (1) visualization of 
...
provide additional qualitative understanding of data.
...
not observed when the mesh size is greater than 
0.05~\si{\m}.~\citet{Coetzee2005} also found that the numerical error decreases 
with 
...
%\caption{Radom polydisperse grains arranged in a regular lattice, showing 
...
descent; (b) small-scale periodic sample~\citep{Radjai2011}}
\label{fig:ballistic}
\end{figure} 
