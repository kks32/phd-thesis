...
deformations~\citep{Mackenzie-Helnwein2010,Shin2010a}. Although, not derived 
directly from what is classically considered as mesh-free or mesh-less methods, 
MPM is 
still considered as a mesh-free approach, primarily because the initial 
discretisation of the material does not involve a polygonal tessellation, as in 
...
node). The Material Point Method involves discretising the domain $\Omega$ with 
...
the continuum, at time \textit{t}. MPM discretises the continuum body into 
...
A step-by-step solution scheme for Material Point Method~\citep{Bandara2013} is 
...
%technique]{Histogram 
%showing the variation in the number of grains with the coordination number 
%for 9 
%representative 
