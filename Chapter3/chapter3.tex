...
DEM simulations can more easily capture the complex flow mechanics of 
...
methods employed in the DEM should try to minimize the computation of 
...
never collide without being recognized as neighbours first. This is explained 
