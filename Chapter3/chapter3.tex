...
points cast serious doubt on the prospects of a continuum law. The fifth means 
that the full stress tensor must be described, and it may depend on strain, 
deformation rate, and material variables that can evolve during the 
...
dependent behaviour. Another continuum based model is the partial fluidisation 
...
trajectory. This phenomenon is called the Lyapunov instability, and it is 
