...
generated (\cref{fig:ini_sample}). The radii of the grains are chosen from the 
...
behaviour is also investigated. The grain-scale response is captured using a 
...
packing density from micro-scale properties such as local packing fraction. 
