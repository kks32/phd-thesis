...
LBM particles are simulated to flow through a 2D rectangular channel of `L/H' 
...
One important quantity taken into account in the present analysis is the Strouhal number
St a dimensionless number describing oscillating flow dynamics, computed from the cylinder 
diameter D, the measured frequency of the vortex shedding f and the maximum velocity $U_{max}$ at 
the inflow plane
%
\begin{equation}
St=\frac{fD}{U_{max}}\,.
\end{equation}
%TODO: Re-112.5 => 0.1412
%************************************************************************* %
...
%TODO: GPU 7.5 Million Nodes + 2500 particles - 20s (220x), CPU - 12 cores 
%(150s)4.5x, CPU - 4 threads  Single thread -  660s (1x) and 
