...
Fourier Transform - FFT) of time series of drag force. 

%\begin{minipage}{\textwidth}
\begin{table}[tbhp]
	\caption{Computed Strouhal number for fluid flows with different Reynolds number}
	...
	\begin{tabular}{l l l}
		...
		\cmidrule{2-3}
		& LBM & FVM \tablefootnote{FVM results are obtained from~\citet{Breuer2000}}\\
		\midrule
		55		& 0.117	 &	0.117 \\
		75		& 0.128	 &	0.129 \\
		112.5	& 0.141  &	0.141 \\
...
%TODO: GPU 7.5 Million Nodes + 2500 particles - 20s (0x), CPU - 12 cores 
%(150s)16x, CPU - 4 threads 660s(3.8x)  Single thread -  2520s (1x) and 
