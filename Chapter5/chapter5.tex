...
local rheology of granular flows in fluid. The Smagorinsky turbulence model is 
implement in LBM to capture the unsteady flow dynamics in 
underwater granular avalanches. The GPGPU implementation of the coupled 
LBM--DEM technique offers the possibility to capture the intricate microscale 
effects such as the hydrodynamic instabilities, which are otherwise largely 
ignored. The GPGPU implementation also offers the capability to model large 
scale fluid -- grain systems. 