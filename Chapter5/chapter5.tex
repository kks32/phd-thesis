...
ability to simulate the interactions at the dynamic fluid -- solid boundary . 
In principle, the conventional FE and FVM based 
...
dealt with DEM technique. To solve the coupled DEM--LBM formulation, the 
hydrodynamic force exerted on the soil grain and the static buoyancy force are 
...
between the particles (normalised to the diameter of the grain D) are tracked 
...
gap $\delta$ between the particles is zero, but the actual gap is about one 
