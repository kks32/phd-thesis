...
The loop nests in a kernel construct are converted by the compiler into 
parallel kernels that run efficiently on a GPU. There are three steps to this 
...
implementation. GPGPU implementation using OpenACC delivered an impressive 
