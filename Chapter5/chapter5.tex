...
\end{equation}
%
\noindent where $R_{e}$ is the Reynold's number. The velocity profile at steady 
...
maximum horizontal velocity is observed in both LBM and CFD 
...
flow for different Reynolds numbers are shown in~\cref{fig:karman}. It can be 
