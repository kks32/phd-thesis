...
Fourier Transform - FFT) of time series of the fluid pressure. 
\Cref{table:strouhal} shows that the Strouhal number computed from LBM has a 
very good agreement with the FVM results obtained by~\citep{Breuer2000}. This 
shows the ability of LBM in capturing unsteady oscillating flow dynamics.
