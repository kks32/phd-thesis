...
such as grain rearrangement, and (c) the \textit{macroscopic scale}. The 
momentum transfer between the discrete and the continuum phases affects the 
dynamics of the flow. In this study, a multi-scale approach, i.e. 
discrete-element and continuum analyses, is adopted to understand the rheology 
of granular flows.
...
to be fully understood. Understanding the mechanics of granular flow is of 
particular importance in predicting the run-out distances of debris flows. In 
the present study, two-dimensional plane-strain collapse of granular columns 
are simulated using discrete and continuum approaches. The Material Point 
Method (MPM), a hybrid Eulerian -- Lagrangian approach is used to describe the 
continuum behaviour of granular column collapse, while the micromechanics is 
captured using Discrete Element Method (DEM). 
