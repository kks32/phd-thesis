...
and the limitations of continuum models.

In the present study, the Generalised Interpolation Material Point Method 
(GI-MPM), a  hybrid Eulerian -- Lagrangian approach is developed to describe 
the continuum behaviour of granular flows. Whereas, the micro-mechanics is 
modelled using Discrete Element Method (DEM). A two-dimensional 
...
collisional dissipation in the initial free-fall regime for tall columns and 
the lack of collisional dissipation in MPM leads to longer 
run-out distances. The classical Mohr-Coloumb model has the 
