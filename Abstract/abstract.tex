...
present study, two-dimensional plane-strain collapse of granular columns are 
simulated using discrete and continuum approaches. The Material Point Method 
(MPM), a hybrid Eulerian -- Lagrangian approach is used to describe the 
