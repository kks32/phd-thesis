...
The momentum and energy transfer will be 
...
\nomenclature[g-epsilon]{$\epsilon$}{Coefficient of restitution}
\nomenclature[G-Gamma]{$\Gamma$}{Dissipation through inelastic collision}
\nomenclature[a-T]{\textit{T}}{Temperature}
\nomenclature[a-c]{\textit{c}}{Concentration in Kinetic theory (or) Pressure 
wave velocity}
...
\rho c \frac{d \mathrm{u}}{dt} = \triangledown p(\rho,c,T,\epsilon) + 
\triangledown \cdot ( \eta (p,\rho,c,T,\epsilon)  \triangledown \mathrm{u}) \,.
\end{equation}
\noindent Conservation of granular energy (granular temperature)
\begin{equation}
\rho c \frac{d T}{dt} = \triangledown \cdot ( \alpha (p,\rho, c, T,\epsilon)  
...
$c$, $\rho$ is the density, $\epsilon$ is the coefficient of restitution, $T$ 
...
\nomenclature[g-tau]{$\tau$}{Shear stress (or) Surface traction}
...
number \textit{I} as
%
\nomenclature[g-mu]{$\mu$}{Coefficient of friction}
...
\nomenclature[a-k]{$k$}{Stiffness of a grain (or) time step}
...
\end{align}
%
\nomenclature[a-f]{\textbf{f} / \textit{F}}{Applied force}
...
\nomenclature[a-m]{\textit{m}}{Mass of a granular column}
...
%
\nomenclature[a-E]{$\mathit{E}$}{Energy}
