...
instability, when the neutrally stable plane makes an angle of 
$\phi_{\textit{I}}$ with the major principle stress axis. The onset of 
instability triggers instability in a narrow wedge of 56\si{\degree} to 
65\si{\degree}, which corresponds to the angle of shear bands: this observation 
...
The velocity field then depends on the position of 
...
The flow evolution as per~\citet{Staron2007a} involves three stages. The first 
