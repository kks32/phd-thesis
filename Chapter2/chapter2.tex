...
\nomenclature[s-o]{\textit{o}}{Initial state}
...
\nomenclature[a-k]{$k$}{Stiffness of a grain}
...
\nomenclature[a-l]{\textit{l}}{Horizontal length scale in shallow water approximation}
