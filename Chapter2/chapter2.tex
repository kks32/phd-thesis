...
also depends on the maximum and the minimum possible void ratios as well as the 
time for microscopic rearrangement of grains. Consider two rows of 
mono-dispersed 
...
The flow dynamics involves spreading of granular mass 
...
\Cref{fig:Runout_PWP_Fluid_Exp} shows the evolution of run-out 
...
The dense column needs to dilate in order to flow. 
